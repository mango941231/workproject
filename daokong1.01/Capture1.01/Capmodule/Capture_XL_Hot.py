...
class Cap_xlhotnews:
    ...
    def capture(self):
        ...
        driver.get(self.url)
        time.sleep(5)
        driver.save_screenshot('/dkpt_pj/jietupicture/xinlang/xinlang.png')  #屏幕截图
        ...
        picture = Image.open('/dkpt_pj/jietupicture/xinlang/xinlang.png')
        pic = picture.crop((xPiont, yPiont, element_width, element_height+150))
        pic.save(r'/dkpt_pj/jietupicture/xinlang/xinlang.png')
        ...
        image = '/dkpt_pj/jietupicture/xinlang/xinlang.png'
        img = cv2.imread(image)
        cv2.rectangle(img, (3, yPiont - yPiontup), (elementhot.size['width'] - 5, element_height - yPiontup), (0, 255, 0),
                      5)
        cv2.imwrite(image, img)
        image = '/dkpt_pj/jietupicture/xinlang/xinlang.png'  #获取图片的二进制字符串
        driver.quit()
