...
class Cap_txhotnews:
    ...
    def capture(self):
        ...
        driver.get(self.url)
        time.sleep(5)
        driver.save_screenshot('/dkpt_pj/jietupicture/tengxun/tengxun.png')  # 屏幕截图
        ...
        image = '/dkpt_pj/jietupicture/tengxun/tengxun.png'
        img = cv2.imread(image)
        cv2.rectangle(img, (xPiont, yPiont), (element_width, element_height), (0, 255, 0), 5)
        cv2.imwrite(image, img)
        image = '/dkpt_pj/jietupicture/tengxun/tengxun.png'  # 获取图片的二进制字符串
        driver.quit()
