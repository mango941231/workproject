        ...
        async with aiohttp.ClientSession() as session:
            async with session.get(pagesurl) as pageshtml:
                ...
                for com in comments:
                    ...
                    Doc_url = com['doc_url']
                    Agree = com['uptimes']
                    self.cmnt_list.append({'CmtID':CmtID,'Name':Name,'Area':Area,'Content':Content,'Agree':str(Agree),'Time':Time,'Docurl':Doc_url})
    def get_hot(self):
        parms = {
        ...
        for hot in hotcomments:
            ...
            Doc_url = hot['doc_url']
            Agree = hot['uptimes']
            self.hot_list.append({'CmtID': CmtID, 'Name': Name, 'Area': Area, 'Content': Content,'Agree':str(Agree),'Time': Time,'Docurl':Doc_url})
    def main(self):
        self.get_hot()
